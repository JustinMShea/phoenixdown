...
department: 'Continueing Liberal and Professional Studies'
degree: 'Master of Science in Analytics (MScA)'
...
# This chunk ensures that the huskiedown package is installed and loaded. 
# This huskiedown package includes the template files for the thesis.
if(!require(devtools))
  install.packages("devtools", repos = "http://cran.rstudio.com")
if(!require(phoenixdown))
