#' Creates an R Markdown PDF Capstone document
#'
#' This is a function called in output in the YAML of the driver Rmd file to
#' specify using a UChicago Graham School MScA style LaTex and cls file.
#'
#' @export
...
#' @examples
#' \dontrun{
#'  output: phoenixdown::capstone_pdf
#' }
capstone_pdf <- function(toc = TRUE, toc_depth = 3, highlight = "default", ...){
